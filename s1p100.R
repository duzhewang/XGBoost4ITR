...
# Scenario 1: tree-type decision rule 

rm(list=ls())
set.seed(2019)
funcdir="/Users/chang_file/Desktop/itrsimu_ChangLiu/func/"
savedir<-"/Users/chang_file/Desktop/itrsimu_ChangLiu/s1p100/" 
